...
local Window = OrionLib:MakeWindow({Name = "KKK Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "KKK Hub"})
...
W:AddLabel("[+] KKK Hub is HERE! brazilian devs")
